 ...
 */
 package com.nortal.blaze.blockchain;
...
@Component(immediate = true, service = {ResourceAfterSaveInterceptor.class, DocumentNotary.class}, configurationPid = "com.nortal.blaze.blockchain")
